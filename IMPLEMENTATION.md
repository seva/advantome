...
1. ~~Which genome-derived asymmetry classes are credible enough to investigate first?~~ — answered in Phase 1 artifact
...
```
Phase 0 (unfair advantage definition) — complete.
```
